package com.example.videolistwithrecyclerview.util
...
class Resources {
    companion object{
        val MEDIA_OBJECTS = arrayOf(
            MediaObject("Sending Data to a New Activity with Intent Extras",
            ...
            MediaObject("REST API, Retrofit2, MVVM Course SUMMARY",
            ...
            MediaObject("Swiping Views with a ViewPager",
            ...
            MediaObject("Database Cache, MVVM, Retrofit, REST API demo for upcoming course",
